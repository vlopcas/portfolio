...
export default function AboutPage() {
  return <>
    <header className="page-header route-hero about-header"><div className="container"><span className="eyebrow">Sobre mim</span><div className="editorial-heading"><h1 className="page-title">Minha trajetória entre<br/><span>ciência, dados e software.</span></h1><p className="lead">Minha carreira nasceu na ciência e ganhou escala com software, dados e inteligência artificial.</p></div></div></header>
    <section className="container section about-profile">
      <div className="portrait-wrap"><Image className="portrait" src={victorPhoto} alt="Victor Castro" sizes="(max-width: 800px) 80vw, 40vw"/></div>
