...
export const projects: readonly Project[] = [
  {
    ...
    status: "active",
    summary: "Sistema educacional de auditoria documental com recuperação avaliada, roteamento de consultas e compilação segura de contexto.",
    tags: ["Python", "RAG", "Query Understanding", "Context Engineering"],
    ...
    approach: "O fluxo atual combina roteamento explícito, planejamento determinístico e retrieval por passo para consultas decompostas. Antes de qualquer geração, um compilador separa instrução, consulta e evidências não confiáveis, aplica orçamento e preserva provenance. O contexto aprovado é selado por SHA-256 e revalidado por um gateway opt-in que falha fechado, não possui cliente de modelo e permanece desabilitado por padrão. A síntese local e o corpus privado continuam bloqueados após experimentos revelarem falhas de qualidade e segurança.",
    architecture: ["Roteamento e planejamento", "Retrieval por passo", "Compilação de contexto", "Contexto selado", "Gateway opt-in"],
    decisions: ["Evidências são dados não confiáveis, nunca instruções", "Contextos adulterados ou incompletos falham fechados", "Gateway, modelo local e corpus privado permanecem desabilitados por padrão"],
    nextSteps: ["Injetar o gateway como dependência opcional do roteador", "Validar a integração sem habilitar chamadas de modelo", "Manter a síntese local bloqueada até novos gates de qualidade e segurança"],
  },
  {
