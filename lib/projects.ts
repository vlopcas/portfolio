...
export const projects: readonly Project[] = [
  {
    ...
    status: "active",
    summary: "Sistema educacional de auditoria documental com recuperação avaliada, roteamento de consultas e geração local rastreável.",
    tags: ["Python", "RAG", "Query Understanding", "LLM local"],
    ...
    approach: "Além do pipeline documental e do retrieval avaliado, o fluxo atual possui roteamento explícito, planejamento determinístico e execução opt-in de consultas decompostas. Evidências recuperadas por passo são agrupadas sem perder escopo, data ou citações e só liberam uma futura síntese quando o pacote está completo. O contrato de síntese com LLM local já valida afirmações atômicas, mas permanece isolado do runtime: no benchmark sintético, o modelo respondeu corretamente apenas um dos quatro casos respondíveis e variou entre execuções.",
    architecture: ["Parsing e chunking", "Roteamento e planejamento", "Retrieval por passo", "Agrupamento e gate", "Síntese local experimental"],
    decisions: ["Rotas especiais exigem sinais explícitos", "Evidência parcial permanece auditável e bloqueia geração", "Síntese local não integra o runtime sem evidência de qualidade e repetibilidade"],
    nextSteps: ["Medir a repetibilidade da síntese decomposta", "Diagnosticar a abstention excessiva", "Avaliar uma alteração controlada de prompt antes de qualquer holdout"],
  },
  {
