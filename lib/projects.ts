...
export const projects: readonly Project[] = [
  {
    ...
    status: "active",
    summary: "Sistema educacional de auditoria documental que compara retrieval, RAG, regras estruturadas e recuperação assistida por grafo.",
    tags: ["Python", "RAG", "Regras estruturadas", "Graph Retrieval"],
    repository: "https://github.com/vlopcas/medaudit",
    overview: "Um projeto educacional e evolutivo para estudar processamento documental, recuperação de informação, RAG, regras e grafos em um domínio que exige proveniência, abstention, versionamento e revisão humana.",
    problem: "Documentos extensos, versões temporais, regras distribuídas e relações entre entidades dificultam localizar e correlacionar evidências. Em um domínio sensível, o sistema também precisa reconhecer evidência insuficiente, preservar a origem dos fatos e interromper fluxos que não atendam aos critérios de segurança.",
    approach: "O sistema parte de ingestão local, BM25 e roteamento determinístico. Um caminho experimental compila e sela contextos, orquestra síntese opt-in e verifica fatos estruturados antes de liberar uma saída. O ciclo mais recente adicionou regras revisadas e um gateway de grafo explícito: no holdout sintético, o gateway recuperou 4/4 cadeias em que o BM25 obteve 0/4; admissão e publicação versionada do catálogo também atingiram 8/8. A suíte atual soma 337 testes. Os resultados são restritos a dados sintéticos: modelo local, extração automática, runtime padrão e corpus privado continuam bloqueados.",
    architecture: ["Documentos e snapshots", "Retrieval e roteamento", "Contexto e verificação", "Regras estruturadas", "Grafo explícito e opt-in"],
    decisions: ["BM25 permanece como baseline até outra abordagem demonstrar ganho mensurável", "Regras e grafos aceitam apenas entradas revisadas, versionadas e com provenance", "Falhas de qualidade ou segurança bloqueiam geração, publicação e acesso ao corpus privado"],
    nextSteps: ["Escolher o próximo gate a partir do roadmap arquitetural", "Comparar tools tipadas e workflows determinísticos antes de introduzir agentes", "Manter extração automática, runtime padrão e corpus privado fora dos caminhos experimentais"],
  },
  {
